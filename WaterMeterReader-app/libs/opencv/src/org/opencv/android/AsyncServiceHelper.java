...
public class AsyncServiceHelper
{
    ...
    public AsyncServiceHelper(String Version, Context AppContext, LoaderCallbackInterface Callback)
    {
    ...
    public static void InstallService(final Context AppContext, final LoaderCallbackInterface Callback)
    {
